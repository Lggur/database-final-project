...
-- Задача 3
SELECT 'Определение лучших классов по среднему показателю и вывод информации об автомобилях из этих классов' AS 'Задача 3';
...
-- Задача 5
SELECT 'Анализ машин чья средняя позиция хуже третьей, с подсчетом количества низких результатов в рамках их классов' AS 'Задача 5';
WITH cars_stats AS (
    SELECT
        c.name AS car_name,
        c.class AS car_class,

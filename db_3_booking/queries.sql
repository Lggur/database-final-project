...
-- Задача 1
SELECT 'Поиск лояльных клиентов, совершивших больше двух бронирований в разных отелях' AS 'Задача 1';
SELECT 
	c.name,
	c.email,
	c.phone,
...
-- Задача 3
SELECT 'Сегментация клиентов по предпочитаемым отелей (Дешевый/Средний/Дорогой)' AS 'Задача 3';
